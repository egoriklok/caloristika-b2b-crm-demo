...
const evidence = [
  ...
  },
  {
    ...
    text: "Поэтому демо продает не замену кабинета, а CRM-контур продаж: лиды, дегустации, пилоты, SKU-матрицы и повторные заказы.",
    href: "https://caloristikab2b.ru/"
  },
  {
...
const workflow = [
  ...
  },
  {
    ...
    text: "Пробная поставка превращается в повторный заказ, а не остается в переписке."
  },
  {
    icon: Bot,
    title: "AI-задачи",
...
const objections = [
  ...
  {
    q: "Нам не нужна еще одна система",
      ...
      <main id="top">
            ...
            <div className="flex flex-col gap-7">
              ...
              <div className="flex flex-col gap-5">
                <h1 className="max-w-4xl text-5xl font-semibold leading-none tracking-normal md:text-7xl">
                  CRM, которая доводит партнера Caloristika от лида до повторного заказа
                </h1>
                <p className="max-w-3xl text-xl leading-8 text-muted-foreground md:text-2xl">
                  На встрече показываем не абстрактную систему, а готовый laptop demo:
        ...
        <section id="workflow" className="px-5 py-14 md:px-8">
          <SectionHeading label="Процесс продажи" title="Один экран объясняет путь от базы до денег">
            Главная мысль для Caloristika: CRM нужна не ради отчетности, а чтобы ни один партнер после дегустации не
            завис без следующего действия.
          </SectionHeading>
          ...
          <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[0.85fr_1.15fr]">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-lg leading-8 text-muted-foreground">
                ...
                видно, что рост упирается не только в сайт и личный кабинет, а в управляемую воронку партнеров:
                лид, дегустация, матрица, пилот, повтор. Я могу показать демо уже под ваши сегменты.”
              </p>
            </div>
            <Card>
              <CardHeader>
